...
def get_path_inside_newborn_entry(newborn_entry_path, rel_install_dir, inside_install_dir):
    """
    ...
    if rel_install_dir:
        os.makedirs( os.path.join(newborn_entry_path, *path_to_list(rel_install_dir)) )

    return os.path.join(newborn_entry_path, *path_to_list(rel_install_dir), *path_to_list(inside_install_dir))
