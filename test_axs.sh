...
axs work_collection , attached_entry examplepage_recipe , plant url http://example.com/ dl_file_name example.html _parent_entries --,:=AS^IS:^:byname:downloader , save
axs byname examplepage_recipe , download
assert 'axs byquery downloaded,dl_file_name=example.html , file_path: get_path , , byquery shell_tool,can_compute_md5 , run' '84238dfc8092e5d9c0dac8ef93371a07'
axs byquery shell_tool,can_compute_md5 --- , remove

#axs byquery downloaded,dl_file_name=example.html , get _replay --entry_name=replay_examplepage_downloaded
...
axs byquery downloaded,dl_file_name=example.html --- , remove
