...
export INFERENCE_OUTPUT=`axs byname pytorch_image_classifier , run --torchvision_query+=package_version=$TORCH_VISION_VERSION ---capture_output=true --output_file_path=`
